...
def _find_bp_toolkit() -> Optional[Path]:
    ...
    """
    # Path relative to this file: Python/mcp/services/ -> bp_toolkit/
...
if BP_TOOLKIT_PATH:
    ...
    TOOLS = [
        # --- Core Operations ---
        {
            ...
            "description": "Export a uasset file to JSON using UAssetGUI. Returns the JSON path on success.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "uasset_path": {"type": "string", "description": "Path to the .uasset file"},
                    "ue_version": {"type": "string", "description": "UE version (default: VER_UE5_4)"}
                },
        ...
        },
        {
            ...
            "description": "Import modified JSON back to uasset format using UAssetGUI.",
            "inputSchema": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "bp_detect_type",
            "description": "Detect the type of a UAssetAPI JSON export (Blueprint, PCGGraph, DataAsset, BehaviorTree, Material, etc.)",
            "inputSchema": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "bp_get_info",
            "description": "Get info about an asset JSON (type, exports count, graphs, namemap size)",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"}
        ...
        },
        {
            ...
            "description": "List all properties in an asset export with their types and values",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"},
                    "export_index": {"type": "integer", "description": "Export index (default: 0, the main asset)"}
                },
                "required": ["json_path"]
            }
        },
        {
            ...
            "description": "Get a property value by path (e.g., 'BiomeDefinition.BiomePriority', 'BiomeAssets[0].Generator')",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"},
                    "property_path": {"type": "string", "description": "Property path to retrieve"},
                    "export_index": {"type": "integer", "description": "Export index (default: 0)"}
                },
        ...
        },
        {
            ...
            "description": "Set a property value by path. Saves the modified JSON in-place or to output_path.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"},
                    "property_path": {"type": "string", "description": "Property path to modify"},
        ...
        {
            "name": "bp_clone_asset",
            "description": "Clone an asset JSON as a new asset with a different name. Creates a new JSON file.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the source JSON file"},
                    "new_name": {"type": "string", "description": "Name for the new asset"},
                    "new_folder_path": {"type": "string", "description": "New folder path (optional)"},
                    "output_path": {"type": "string", "description": "Output JSON path (default: auto-generated)"}
                },
                "required": ["json_path", "new_name"]
            }
        },

        # --- Blueprint/PCG Modification ---
        {
            "name": "bp_list_graphs",
            "description": "List all graphs in a Blueprint or PCG asset",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"}
        ...
        {
            "name": "bp_add_comment",
            "description": "Add a comment node to a Blueprint graph",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"},
                    "graph_name": {"type": "string", "description": "Target graph name (e.g., EventGraph)"},
                    "text": {"type": "string", "description": "Comment text"},
                    "x": {"type": "integer", "description": "X position (default: 0)"},
                    "y": {"type": "integer", "description": "Y position (default: 0)"},
                    "width": {"type": "integer", "description": "Width (default: 400)"},
                    "height": {"type": "integer", "description": "Height (default: 200)"},
                    "output_path": {"type": "string", "description": "Output path (default: overwrite)"}
                },
                "required": ["json_path", "graph_name", "text"]
            }
        },
        {
            "name": "bp_clone_node",
            "description": "Clone an existing node in a Blueprint (preserves pins/connections)",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"},
                    "node_name": {"type": "string", "description": "ObjectName of node to clone"},
                    "offset_x": {"type": "integer", "description": "X offset (default: 200)"},
                    "offset_y": {"type": "integer", "description": "Y offset (default: 100)"},
                    "output_path": {"type": "string", "description": "Output path (default: overwrite)"}
                },
        ...
        {
            "name": "bp_find",
            "description": "Search for a pattern in asset namemap and exports",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"},
        ...
        {
            "name": "bp_query",
            "description": "Run a type-specific query (list-events, list-tasks, textures, etc.)",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"},
                    "query_type": {
                        "type": "string",
                        "description": "Query type. Blueprint: list-events, list-functions, variables, comments, flow-tagged. BehaviorTree: list-tasks, blackboard. PCGGraph: list-nodes, connections. Material: textures."
                    },
                    "pattern": {"type": "string", "description": "Pattern for 'find' query type"}
                },
                "required": ["json_path", "query_type"]
            }
        },
        ...
        {
            "name": "bp_parse",
            "description": "Parse a Blueprint JSON into organized documentation with call graphs and Mermaid diagrams",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "json_path": {"type": "string", "description": "Path to the JSON file"},
                    "output_dir": {"type": "string", "description": "Output directory for parsed files"}
                },
                "required": ["json_path"]
            }
        },
